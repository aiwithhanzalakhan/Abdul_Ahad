      ...
      >
        ...
        <div>
          <h1 className="text-4xl md:text-5xl font-bold">
            Hi, I &apos;m <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-indigo-600">Abdul Ahad</span> 👋
          </h1>
        ...
        <motion.div
          ...
          <div className="relative w-[340px] h-[340px]">
            <motion.div
              animate={{ rotate: 360 }}
              transition={{ repeat: Infinity, duration: 10, ease: "linear" }}
              className="absolute inset-0 rounded-full bg-gradient-to-tr from-indigo-500 via-purple-500 to-pink-500 blur-[1px]"
            />
