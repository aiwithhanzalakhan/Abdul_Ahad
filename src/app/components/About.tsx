    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
        ...
        >
          ...
          >
            I&apos;m <span className="font-semibold text-white">Abdul Ahad</span>, 
            a frontend-focused developer creating fast, responsive, and visually appealing 
            web interfaces using Next.js, React, and Tailwind CSS.
          </motion.p>
          ...
          >
            {skills.map((skill) => (
              <motion.span
                ...
                whileTap={{ scale: 0.96 }}
                className="px-5 py-2 text-sm font-semibold rounded-full
                bg-black/10 backdrop-blur border border-white/10"
              >
                {skill}
              </motion.span>
            ))}
