      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 md:col-span-2 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                <li><a href="mailto:hanzalakhan6226@gmail.com" className="hover:text-indigo-600 transition">Email</a></li>
                <li><a href="https://www.linkedin.com/in/hanzala-khan-dev/" target="_blank" className="hover:text-indigo-600 transition">LinkedIn</a></li>
                <li><a href="https://github.com/aiwithhanzalakhan" target="_blank" className="hover:text-indigo-600 transition">GitHub</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <motion.a whileHover={{ scale: 1.2 }} href="https://github.com/aiwithhanzalakhan" target="_blank" className="p-2 bg-white/10 hover:bg-indigo-600 rounded-full transition">
                  <Github className="w-5 h-5 text-white" />
                </motion.a>
                <motion.a whileHover={{ scale: 1.2 }} href="https://www.linkedin.com/in/hanzala-khan-dev/" target="_blank" className="p-2 bg-white/10 hover:bg-indigo-600 rounded-full transition">
                  <Linkedin className="w-5 h-5 text-white" />
                </motion.a>
                <motion.a whileHover={{ scale: 1.2 }} href="mailto:hanzalakhan6226@gmail.com" className="p-2 bg-white/10 hover:bg-indigo-600 rounded-full transition">
                  <Mail className="w-5 h-5 text-white" />
                </motion.a>
                <motion.a whileHover={{ scale: 1.2 }} href="https://twitter.com/" target="_blank" className="p-2 bg-white/10 hover:bg-indigo-600 rounded-full transition">
        ...
        >
          ...
          <motion.button
            ...
            className="mt-4 md:mt-0 flex items-center gap-2 text-gray-300 hover:text-indigo-600 transition"
          >
